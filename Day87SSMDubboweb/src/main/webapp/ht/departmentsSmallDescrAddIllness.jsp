    ...
    <form class="layui-form">
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label"><b>科室</b></label>
                <div class="layui-input-inline">
                    <input type="text" id="dsmall" value="${dsmall.dsname}" name="phone" readonly autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label"><b>疾病</b></label>
                <div class="layui-input-inline">
                    <input type="text" id="ilname" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
        ...
        $(document).ready(function(){
            ...
            $("#submitBut").on("click",function () {
                ...
                if (ilname.length == 0){
                    ...
                    $.post("/departmentsSmallDescrAddIllnessSubmit",{ilname:ilname,dsmall:dsmall,remarkes:remarkes},function (date) {
                        if(date){
                            window.parent.location.reload();
                        }else{
                            layer.alert("疾病信息增加失败");
                        }
                    });
                }
            });
