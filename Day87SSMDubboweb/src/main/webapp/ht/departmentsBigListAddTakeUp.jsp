        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="dbigks" value="${departmentsBig.dbname}" name="phone" readonly autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label"><b>二级科室</b></label>
                <div class="layui-input-inline">
                    <input type="text" id="dsmall" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
        ...
        $(document).ready(function(){
            ...
            $("#submitBut").on("click",function () {
                ...
                if (dsmall.length == 0){
                    ...
                    $.post("/departmentsBigListAddTakeUpSubmit",{dbigks:dbigks,dsmall:dsmall,remarkes:remarkes},function (date) {
                        if(date){
                            layer.alert("二级科室信息增加成功");
                            window.parent.location.reload();
                        }else{
                            layer.alert("二级科室信息增加失败");
                        }
                    });
                }
            });
