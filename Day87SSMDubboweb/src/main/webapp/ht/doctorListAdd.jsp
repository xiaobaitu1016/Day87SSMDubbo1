    ...
    <div class="w900 fl">
        ...
        <form action="" method="post" class="layui-form layui-form-pane">
            <table class="layui-table" style="text-align: center;margin-top: 50px">
                <thead>
                <tr>
                    <th colspan="4"><center><h3><b>新增医生信息</b></h3></center></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <tr>
                    <td>科室：</td>
                    <td>
                        <select id="dsid" lay-filter="dsid" lay-verify="required">
        ...
        layui.use(['form', 'layedit', 'laydate','table'], function(){
            ...
            $("#submitBut").on("click",function () {
                ...
                layer.confirm("确定新增？",function (index) {
                    ...
                    $.post("/htAddDoctorByDoctor",{dname:dname,dsid:dsid,drid:drid,
